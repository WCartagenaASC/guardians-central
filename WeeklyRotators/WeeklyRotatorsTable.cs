        ...
        Mapping = new Dictionary<string, List<long>>{
            ...
            { "Prophecy", new List<long> 
                {
                    ...
                    4121885325,2487240821,2701727616,2288398391,1361912510,1658294130,1781294872,2295111683
                } 
            },
            ...
            { "Duality", new List<long> 
                {
                    ...
                    2364756343,3070295330,630469185,630469185,630469185,3798520466,3742442925 
                } 
            },
            ...
            { "Presage", new List<long> 
                { 
                    ...
                    1795075811,3004041686,1285042454,2489136103,29154321,1241941801,2224584236,217647949,870313788,1972851364,256122438,2716681465
                }
            }
        };
    }
